...
import { Input, Card, Typography, Space, Table, DatePicker, Select, Row, Col, Avatar, Dropdown, Menu, Form } from 'antd';
    ...
    render() {
        ...
        return (
            <Row justify="center" align="middle">
                <Col span={20}>
                    <Title level={2} style={{ ...pageHeaderStyle, marginTop: '64px', marginBottom: '0px', textAlign: 'left', color: '#262626' }}>Public business plans</Title>
