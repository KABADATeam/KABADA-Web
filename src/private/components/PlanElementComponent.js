    ...
    render () {
        return ( 
            <List
                ...
                dataSource={all_plans_data}
                renderItem={item => (
                    <List.Item style={{ width: 282, height: 236, borderRadius: '8px', backgroundColor: '#FFFFFF', }} >
                        <Image  
                        width={282}
                        height= {152}
                        src={item.img}
...
export default PlanElementComponent;