...
import {Card, Typography, Image, List, Row} from 'antd';
...
*/
/*
const businessPlans = this.props.publicPlans.map((item, index) =>
            <div key={index} style={{width: '282px', height: '236px', borderRadius: '8px', backgroundColor: '#FFFFFF'}}>
                <Row>
                    <Image
                        width={282}
                        height= {152}
...
class PlanElementComponent extends Component {
    ...
    render () {
        ...
        return ( 
            ...
            <List
                grid={{ gutter: 16}}
                dataSource={this.props.publicPlans}
                renderItem={item => (
                    <List.Item>
