...
function SalesForecastOutsideEUTable() {
    ...
    return (
        <div>
            ...
            <Table title={() => 'Sales forecast out EU'} columns={columns} dataSource={dataSource} pagination={false} />
...
export default SalesForecastOutsideEUTable
