    ...
    render() {
        ...
        const fixed_costs_columns = [
            ...
            },
            {
                ...
                width: '16%',
                render: (text, record, index) => (
                    <Select defaultValue={text === null ? this.state.vats.standardRate : text} value={text === null ? this.state.vats.standardRate : text}  disabled={true}>
            ...
            },
            {
                ...
                render: (text, record, index) => (
                    <Input.Group compact>
                        <Select value={text === null ? 1 : text}  disabled={true}>
        ...
        const fixed_salaries_costs_columns = [
            ...
            },
            {
                ...
                render: (text, record, index) => (
                    <Input.Group compact>
                        <Select value={text === null ? 1 : text} onChange={e => this.onFixedChange(e, record, "first_expenses")} disabled={true}>
                            {this.state.selectedPeriod.map((value, index) => (
                                <Option value={value}>{value + "st mo."}</Option>
                            ))}
                        </Select>
